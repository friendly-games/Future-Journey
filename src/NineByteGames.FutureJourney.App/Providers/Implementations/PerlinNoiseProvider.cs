...
namespace NineByteGames.FutureJourney.Providers.Implementations
{
  internal class PerlinNoiseProvider : IPerlinNoiseProvider
  {
    ...
    public double perlin(double x, double y, double z)
    {
      ...
      x1 = lerp(grad(_p[aa + 1], xf, yf, zf - 1),
